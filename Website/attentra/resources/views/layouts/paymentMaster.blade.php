                ...
                <ul class="nav navbar-nav navbar-left main-nav">
                    ...
                    @if(!Auth::check())
                        <li class="addNewLink-main-nav2" id="">
                            <a href="#logintoProfileSection"  class="scrollto" data-toggle="modal" data-target="#loginToPro">ورود</a>
                        </li>
                    @endif
            ...
            <div class="row">
                <div class="col-sm-8 text-right text-center-mobile">
                    <p class="copyleft small muted"> تمام حقوق مادی و معنوی این سایت متعلق به
                        ...
                        می باشد. </p>
                    <p class="copyleft small muted"> شما می توانید از این سایتدر صورت پذیرش
        ...
        $("#userFormData").click(function(e){
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        $( "#hiddenMessageUser" ).empty();
                        var errorMessageTag = '<div class="alert alert-success">'+"اطلاعات شما با موفقیت ثبت شد"+' </div>';
