...
<body>
    ...
    <script src="http://localhost:8000/style/profile/test/js/jquery.js"></script>
    <script type="text/javascript">
        ...
        function initialize() {
            ...
            // Multiple Markers
            var markers = [
                ['London Eye, London', 29.622369,52.513858],
...
//                ['Palace of Westminster, London', 29.626957,52.522490]
            ...
            var infoWindowContent = [
                ...
                '<h3>سلام بنده در تاریخ یکم اردیبهشت 95 یک عدد کیف پولی پیدا کردم</h3>' +
                '<p>شماره تلفن من 09171234567 هست با من تماس گرفته و نشانی کیف را به من بدهید.</p>' +        '</div>'],
                ['<div class="info_content">' +
                '<h3>قصابی گوشت تک</h3>' +
