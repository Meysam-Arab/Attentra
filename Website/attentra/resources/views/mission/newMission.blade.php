...
@section('content')
    ...
    <div  class="form-panel">
        ...
        <form action="{{ url('mission/store') }}"  method="post" enctype="multipart/form-data" class="form-horizontal style-form">


                <div class="form-group">
                    <label class="col-sm-1 col-sm-1 control-label" for="title">@Lang('messages.lbl_Title')</label>
                    <div class="col-sm-11">
                        <input class="form-control" data-validation="required" type="text" name="title" placeholder="@Lang('messages.lbl_Title')" value="{{ old('title') }}" >
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <textarea class="form-control" type="text" name="description" placeholder="" >{{ old('description') }}</textarea>
                    </div>
                ...
                <div class="form-group" style="direction: ltr;">
                    <div class="input-group col-lg-4 " style="margin:0px 20px 0px 20px;float:right;">
                        ...
                        <input type="text"  name="start_date_time" class="form-control ALAKI12" id="fromDate1" placeholder="@Lang('messages.lbl_FromDate')" data-mddatetimepicker="true" data-trigger="click" data-targetselector="#fromDate1" data-groupid="group1" data-fromdate="true" data-enabletimepicker="true" data-placement="right" value="{{\Morilog\Jalali\jDateTime::convertNumbers(\Morilog\Jalali\jDateTime::strftime('Y/m/d H:i:s', strtotime(old('start_date_time'))))}}" />
                    </div>
                    <div class="input-group col-lg-4" style="margin:0px 20px 0px 20px;float:right;">
                        <div class="input-group-addon" style="background-color: #7CC576;color: white;">
                            <span class="">تاریخ پایان</span>
                        </div>
                        <input type="text"  name="end_date_time" class="form-control ALAKI13" id="toDate1" placeholder="@Lang('messages.lbl_ToDate')"/>
                    </div>
                </div>
                            ...
                            <table id="example" class="display nowrap full-width"  cellspacing="0" width="100%" >
                                ...
                                @foreach($usersOfCompany as $user)
                                    <tr>
                                        <td>{{$user->name}}</td>
                                        <td>{{$user->family}}</td>
                                        <td><input type='checkbox' name='missionperson[{{$user->user_id}}]' value='{{$user->user_id}}'></td>
                                    </tr>
                                @endforeach
                                </tbody>
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        {{--{!! Form::submit(Lang::get('messages.َbtn_SaveChanges')) !!}--}}
