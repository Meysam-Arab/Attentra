...
@section('content')
    <div class="form-panel">
        ...
        <form action="{{ url('module/store') }}"  method="post" enctype="multipart/form-data" class="form-horizontal style-form">
            ...
            @foreach($langs as $lang)
                <div id="{{$lang->title}}" class="tabcontent" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" type="text" name="{{$desc}}" placeholder="" >{{ old($desc) }}</textarea>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="limit_value" placeholder="اگر این ماژول محدودیتی در تعداد دارد وارد کنید"  >
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="price" placeholder="به عدد"  >
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::submit('افزودن ماژول جدید',['class' => 'form-control btn btn-theme' ]) !!}
                </div>
            </div>
        </form>
    </div>
