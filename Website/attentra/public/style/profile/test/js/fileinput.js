...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="glyphicon glyphicon-file kv-caption-icons"></i>';
            tCaption = '<div tabindex="500" class="form-control file-caption {class}">\n' +
                '   <div class="file-caption-name"></div>\n' +
                '</div>\n';
            //noinspection HtmlUnknownAttribute
            tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css}" ' +
                '{status}>{icons} {label}</button>';
            //noinspection HtmlUnknownAttribute
            tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icons} {label}</a>';
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css}" {status}>{icons} {label}</div>';
        ...
        _hideFileIcon: function () {
            if (this.overwriteInitial) {
                this.$captionContainer.find('.kv-caption-icons').hide();
            }
        },
        _showFileIcon: function () {
            this.$captionContainer.find('.kv-caption-icons').show();
        },
        ...
        _updateFileDetails: function (numFiles) {
            ...
            if (self.isError) {
                ...
                self.$captionContainer.find('.kv-caption-icons').hide();
            } else {
                self._showFileIcon();
            }
        ...
        _renderButton: function (type) {
            ...
            return tmplt.replace('{type}', btnType).replace('{css}', css).replace('{title}', title)
                .replace('{status}', status).replace('{icons}', icon).replace('{label}', label);
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIconClass: 'file-other-icons',
