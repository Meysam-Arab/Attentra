...
+function ($) { "use strict";
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        var parentLeft   = this.options.container == 'body' ? 0 : $parent.offset().right

        placement = placement == 'bottom' && pos.top   + pos.height  + actualHeight - docScroll > parentHeight  ? 'top'    :
                    placement == 'top'    && pos.top   - docScroll   - actualHeight < 0                         ? 'bottom' :
                    placement == 'left'  && pos.left + actualWidth > parentWidth                              ? 'right'   :
                    placement == 'right'   && pos.right  - actualWidth < parentLeft                               ? 'left'  :
                    placement
  ...
  Tooltip.prototype.applyPlacement = function(offset, placement) {
    ...
    var marginLeft = parseInt($tip.css('margin-right'), 10)
    ...
    offset.right = offset.right + marginLeft
