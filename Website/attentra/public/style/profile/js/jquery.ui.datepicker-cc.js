...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			' title="' + prevText + '"><span class="ui-icons ui-icons-circle-triangle-' + ( isRTL ? 'e' : 'w') + '">' + prevText + '</span></a>' :
			(hideIfNoPrevNext ? '' : '<a style="direction:ltr" class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+ prevText +'"><span class="ui-icons ui-icons-circle-triangle-' + ( isRTL ? 'e' : 'w') + '">' + prevText + '</span></a>'));//[CC]: direction:ltr
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			'.datepicker._adjustDate(\'#' + inst.id + '\', +' + stepMonths + ', \'M\');"' +
			' title="' + nextText + '"><span class="ui-icons ui-icons-circle-triangle-' + ( isRTL ? 'w' : 'e') + '">' + nextText + '</span></a>' :
			(hideIfNoPrevNext ? '' : '<a style="direction:ltr" class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+ nextText + '"><span class="ui-icons ui-icons-circle-triangle-' + ( isRTL ? 'w' : 'e') + '">' + nextText + '</span></a>'));//[CC]: direction:ltr
