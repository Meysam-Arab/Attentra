    ...
    $('form').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response){
                var maData;
                for(maData in response.message){
                    $( "#add_err" ).empty();
                    var errorMessageTag = '<div class="alert alert-danger alert-dismissable fade in someClass noPrint"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'+response.message[maData]+' </div>';
                    $("#add_err").append(errorMessageTag);
                }
