...
(function ($) {
  ...
  $.formUtils = {
     ...
     */
    LANG: {
      errorTitle: 'ثبت نام این فرم با موفقیت همراه نبود',
      requiredFields: 'این مورد را حتما پر کنید',
      badTime: 'زمان درست نیست',
      badEmail: 'ایمیل درست وارد نشده',
      badTelephone: 'شماره تلفن را درست وارد کنید',
      badSecurityAnswer: 'به سوال امنیتی درست جواب بدهید',
      badDate: 'تاریخ صحیح نیست',
      lengthBadStart: 'مقدار باید بین ',
      lengthBadEnd: ' کاراکتر باشد',
      lengthTooLongStart: 'مقدار وارد شده بیشتر ',
      lengthTooShortStart: 'مقدار وارد شده حداقل باید ',
      notConfirmed: 'مقدار وارد شده مورد قبول نیست',
      badDomain: 'دامنه صحیحی وارد نشده',
      badUrl: 'The input value is not a correct URL',
      badCustomVal: 'مقدار ورودی صحیح نیست',
      andSpaces: ' و فاصله ها ',
      badInt: 'مقدار وارد شده عدد صحیحی نیست',
      badSecurityNumber: 'Your social security number was incorrect',
      badUKVatAnswer: 'Incorrect UK VAT Number',
      badStrength: 'رمز عبور شما خیلی قوی نیست و قابل حدس می باشد',
      badNumberOfSelectedOptionsStart: 'حداقل انتخاب کنید مورد را ',
      badNumberOfSelectedOptionsEnd: ' جواب ها',
      badAlphaNumeric: 'مقدار وارد شده فقط می تواند شامل حروف باشد ',
      ...
      groupCheckedEnd: ' مورد(ها)',
      badCreditCard: 'The credit card number is not correct',
      badCVV: 'The CVV number was not correct',
      wrongFileDim : 'Incorrect image dimensions,',
      imageTooTall : 'ارتفاع عکس نباید بیشتر از ',
      imageTooWide : 'عکس نباید عریض تر از',
      imageTooSmall : 'اندازه عکس خیلی کوچک است',
      min : 'حداقل',
      max : 'حداکثر',
  ...
  $.formUtils.addValidator({
    ...
    validatorFunction: function (url) {
      ...
      if (urlFilter.test(url)) {
        ...
        return $.formUtils.validators.validate_domain.validatorFunction(domain); //  add support for IP-addresses
      }
      return false;
    },
    errorMessage: '',
